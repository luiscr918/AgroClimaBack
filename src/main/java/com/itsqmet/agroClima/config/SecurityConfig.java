package com.itsqmet.agroClima.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // Configuración de CORS y CSRF usando la nueva sintaxis
        http
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        source.registerCorsConfiguration("/**", configuration); // todos los endpoints
        return source;
    }
}
